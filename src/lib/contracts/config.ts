...
export const CONTRACT_ADDRESSES: Record<number, NetworkContractAddresses> = {
  ...
  [baseSepolia.id]: {
    CREATOR_REGISTRY: '0xe94Dbb72BDd8604E25A2C7d2cf9Bad71F2870d5B' as Address,
    CONTENT_REGISTRY: '0x981f162aa0D25C660C2658f50904Cb3b33AfA406' as Address,
    PAY_PER_VIEW: '0x559B0FaF011e95D3B634a88390cD320f186141D0' as Address,
    SUBSCRIPTION_MANAGER: '0xeBA8d808105097b3A14Ee7b70716BbDB49798099' as Address,
    COMMERCE_INTEGRATION: '0x8cbcD15F39BDAB3a15908d9a730870383ab7cfe3' as Address,
    PRICE_ORACLE: '0x02df436c2a4DFd8EFd0FDd791853Be75d1D46431' as Address,
