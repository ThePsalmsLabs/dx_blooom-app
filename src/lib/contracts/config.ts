...
export const CONTRACT_ADDRESSES: Record<number, NetworkContractAddresses> = {
  ...
  [baseSepolia.id]: {
    CREATOR_REGISTRY: '0x2a8e3cEE1034C2f502440eC63c926d3D7796d0e1' as Address,
    CONTENT_REGISTRY: '0x1D740bec9B08D5f954b5B55E4178909BfDE506b0' as Address,
    PAY_PER_VIEW: '0x2334DB4A7a05014B6b61e382aBd4057066312024' as Address,
    SUBSCRIPTION_MANAGER: '0x1C5d2c66694013ccFd0Df1E41C25e6679b21757c' as Address,
    COMMERCE_INTEGRATION: '0xCDE624781EAdDCf6A5B1333F37CC8F49edFDEbEC' as Address,
    PRICE_ORACLE: '0x038F1e4437497Dc6B3479669B5495f5B3E831bE7' as Address,
