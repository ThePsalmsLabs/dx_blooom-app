...
export const COMMERCE_PROTOCOL_PERMIT_ABI = [
  ...
  { type: "function", name: "rewardsIntegration", inputs: [], outputs: [{ name: "", type: "address", internalType: "contract RewardsIntegration" }], stateMutability: "view" },
  {
    type: "function",
    name: "setPayPerView",
    inputs: [{ name: "_payPerView", type: "address", internalType: "address" }],
    outputs: [],
    stateMutability: "nonpayable"
  },
  {
    ...
    inputs: [{ name: "_rewardsIntegration", type: "address", internalType: "address" }],
    outputs: [],
    stateMutability: "nonpayable"
  },
  {
    ...
    inputs: [{ name: "_subscriptionManager", type: "address", internalType: "address" }],
    outputs: [],
    stateMutability: "nonpayable"
  },
  ...
  { type: "function", name: "unpause", inputs: [], outputs: [], stateMutability: "nonpayable" },
  {
    ...
    inputs: [{ name: "newDestination", type: "address", internalType: "address" }],
    outputs: [],
    stateMutability: "nonpayable"
  },
  {
